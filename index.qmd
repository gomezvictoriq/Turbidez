...
abstract: |
  Este sitio web contiene información sobre la estimación de la turbidez por teledetección en la cuenca media del Río Paraná. Se utilizarán imágenes del satélite Sentinel-2 con correccíon automática, de las cuales se obtiene la reflectancia de la superfie del agua. Se buscará la relación entre la reflectancia y la turbidez por métodos de regresion tradionales y machine learning.
  La turbidez es uno parámetros de interés dentro proyecto "Estimar indicadores de la calidad del agua en la cuenca media del río Paraná" que se desarolla en el GISTAQ, UTN- FRRe.
keywords:
  - GISTAQ
  - UTN
  - FRRe
