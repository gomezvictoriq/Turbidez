...
abstract: |
  ...
  Se utilizarán imágenes del satélite Sentinel-2 con correccíon automática, de las cuales se obtiene la reflectancia de superfie del agua. Se buscará la relación entre la reflectancia y la turbidez por métodos de regresión tradionales y machine learning. Una vez obtenido el algoritmo que relacione ambas propiedades, se desarrollaran mapas de distribución espacial.
