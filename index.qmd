...
```
Con la función **print** visualizamos los valores de las métircas de desempeño
```{python}
print("RMSE", p_rmse) 
print("R2", p_r2)
```
...
### Graficamos el modelo tanto con el conjunto de entrenamiento y validación
```{python}
...
ax[0].set(xlabel="Banda", ylabel="Turbidez", title="Conjunto de entrenamiento")
ax[0].legend()
...
ax[1].set(xlabel="Banda", ylabel="Turbidez", title="Conjunto de validación")
ax[1].legend()
