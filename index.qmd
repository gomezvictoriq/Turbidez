...
# Lectura automática de tif y procesamiento para mapas de turbidez, cálculo de umbral de mácara de agua con método Otsu
...
# Conclusión para modelos entrenados con métodos de regresion lineal clásicos
...
# Método de aprendizaje automático XGBoost
...
## Modelo XGBoost optimizado con Grid Search (Búsqueda por cuadrícula)
...
![Bandas de Sentinel-2](D:\GIT\Turbidez\img\Bandas-satélite-imágenes-Sentinel-2.jpg){fig-align="center"}
...
Las bandas Red Edge (B05–B06-B07) se ubican justo en la transición entre el rojo y el infrarrojo cercano, donde la reflectancia del agua cambia mucho con la concentración de sedimentos.
→ Son excelentes indicadores de turbidez o material particulado suspendido.

Las bandas azules (B01–B02) todavía aportan algo, porque la turbidez afecta la dispersión del azul.
→ En aguas claras, el azul predomina; en aguas turbias, se atenúa.
...
## Mapas XGBOOST con hiperparámetros optimizados
