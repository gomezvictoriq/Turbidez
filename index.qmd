...
![Boostrapping](D:\GIT\Turbidez\img\Bootstrapping.jpg)
...
## Combinación 1: Turbidez vs Bandas

### Modelo con B05

$\text{Turbidez} = 1290.3786 \cdot B05 - 46.2658$
...
# Entrenamiento
plt.scatter(y_train, y_train_pred, color="#9D50A6", alpha=0.5, label="Datos de entrenamiento")

# Test
plt.scatter(y_test, y_test_pred, color="red", alpha=0.7, label="Datos de testeo")
...
# ------------------ Coeficientes ------------------ #
print("\nEcuación promedio del modelo:")
for var, coef in zip(variables, coef_prom):
    print(f"  {var}: {coef:.4f}")
print(f"Intercepto: {intercept_prom:.4f}")
```

### Modelo con 6 bandas

$\text{Turbidez} = -199.0357 \cdot B05 + 4709.7174 \cdot B06 - 315.5704 \cdot B08 + 1692.5113 \cdot B07 - 706.0229 \cdot B04 - 4498.4379 \cdot B8A - 4.5705$
...
## Modelos con logaritmo en turbidez y bandas
### Modelo con 1 variable (ln_B05)

$\text{Turbidez} \approx e^{8.0315} \cdot B05^{1.7569}$
...
plt.ylabel("Turbidez predicha (NTU)")
plt.title(
...
Aplicamos la ecuacion hallada para ver la distribución de la turbidez en el río.
