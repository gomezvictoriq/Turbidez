...
Importamos las funciones que nos interesan y leemos el archivo csv creado previamente.
...
Definimos X para que sea los valores de reflectancia de una banda en particular
Defiinimos y para que sea la turbidez
...
### Gráficas del conjunto de entrenamiento y validación
```{python}
