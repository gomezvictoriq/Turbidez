...
La distribución de importancias indica que la turbidez está fuertemente asociada a la reflectancia capturada por B05 y B06, mientras que el resto de las bandas aportan información secundaria. Esto es consistente con la sensibilidad del espectro del infrarrojo cercano y rojo a la materia en suspensión, lo cual valida físicamente la interpretación del modelo.
